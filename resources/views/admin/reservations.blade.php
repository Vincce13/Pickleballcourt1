...
<aside class="sidebar">
    ...
    <a href="{{ route('admin.reservations') }}" class="sidebar-link active"><span class="icon">📋</span>  Reservations</a>
    ...
    <div class="content">
        ...
        <form method="GET" action="{{ route('admin.reservations') }}" id="filterForm">
            <div class="filters">
                ...
                <div class="filter-group">
                    <label>Court</label>
                    <select name="court" id="courtSelect">
...
<script>
    ...
    // Auto-submit when dropdowns or date change (no button click needed)
    statusSelect.addEventListener('change', () => form.submit());
    courtSelect.addEventListener('change',  () => form.submit());
